...
| id | category | weight | reason | fundamento | referencia normativa |
|---|---|---:|---|---|---|
...
| `entity.sii_suspendido` | entity | -30 | Estado 'suspendido' en el SII | Suspensión SII es señal regulatoria dura: la entidad no debería estar realizando operaciones con público mientras esté en ese estado. | [`CL-CT-66`](https://www.bcn.cl/leychile/navegar?idNorma=6374) |
| `entity.sii_sin_inicio` | entity | -50 | Sin inicio de actividades en el SII | Si una empresa que ofrece servicios financieros no figura con inicio de actividades, no existe formalmente en el sistema tributario chileno; es prácticamente concluyente. | [`CL-CT-66`](https://www.bcn.cl/leychile/navegar?idNorma=6374) |
